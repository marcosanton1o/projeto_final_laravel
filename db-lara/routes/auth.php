...
use App\Middleware\Admin_postmiddleware;
...
Route::get('/', [RoleController::class, 'index'])->name('welcome');
...
//middleware
Route::get('/user', function () {
    return view('dashboard');})->middleware(['auth', 'verified','Usermiddleware'])->name('user');

Route::get('/admin', function () {
    return view('admin');})->middleware(['auth', 'verified','Adminmiddleware'])->name('admin');
